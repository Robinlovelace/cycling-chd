...
groups, active transport was associated with a (YJN edit: missing word lower??)likelihood of being overweight
...
YJN Comment - I got lost in the detail in this section... perhaps needs simplifying? Or setting out subtitles
...
YJN edits:
QOF data is available by GP practice - The PHE dataset uses this data combined by Local Authority. Some issues here in terms of people who live in a different LA to where their GP is located. I would pick 3 of these outcomes for simplicity: CHD prevalence, CHD mortality, prevalence hypertension. The confounding variables look reasonable except we may want to try and build in something about air pollution? Also worth being clear what the unit of analysis is here? Different datasets may be available on different footprints...

- CHD prevalence (QOF) (
- CHD mortality in under 75s (age standardised)
- (Heart failure, various parameters) (YJN edit: not sure this is worth it)
- obesity
- prevalence low physical activity (?correlate this with cycling?) - YJN comment: This is likely to be strongly collinear so not sure I would recommend doing?!?
- prevalence hypertension
- percentage of people in most deprived quintile (20%?!) (YJN comment: My feeling is that IMD rank or score would be a better choice for confounding variable)
...
- Methods
This study has used an ecological study design and as such is subject to the ecological fallacy. The findings relate to geographical areas and cannot necessarily be applied to individuals. Efforts have been made to reduce the effect of confounding factors ..
